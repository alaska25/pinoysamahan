    ...
    <div className="admin-auth">
      ...
      <div className="admin-auth__panel">
        ...
        <div className="admin-auth__brand">
          ...
          <h1 className="admin-auth__title">Para sa mga humuhubog ng komunidad.</h1>
          <p className="admin-auth__sub">
            Mag-sign in bilang admin para mag-manage ng events, balita, gallery, at miyembro ng Samahan ng Pinoy | Pinoy sa Japan.
          </p>
        </div>
      </div>
      ...
      <div className="admin-auth__right">
        <div className="admin-auth__card">
          ...
          <p className="admin-auth__register">
            Wala pang account? <Link to="/admin/register">Mag-register dito</Link>
          </p>
        </div>
      </div>
    </div>
